        ...
        <h1> The Developers</h1>
            <div className= 'dev'>
                <div >
                    ...
                    <a href="https://github.com/hninmabalo" target="_blank" rel="noreferrer" > < Github className='github'size='20px' /> </a>
                    <a href="https://www.linkedin.com/in/hnin-mabalo/" target="_blank" rel="noreferrer" > < Linkedin className='linkedin' size='20px' /></a>
                </div>
                ...
                <div >
                    ...
                    <a href="https://github.com/ReneTheMC" target="_blank" rel="noreferrer"> < Github className='github' size='20px' /> </a>
                    <a href="https://www.linkedin.com/in/rene-collins-1a1877152/" target="_blank" rel="noreferrer"> < Linkedin className='linkedin' size='20px' /></a>
                </div>
                ...
                <div >
                    ...
                    <a href="https://github.com/ruraliz" target="_blank" rel="noreferrer"> < Github className='github' size='20px' /> </a>
                    <a href="https://www.linkedin.com/in/liz-rurangwa-liz-rurangwa/" target="_blank" rel="noreferrer"> < Linkedin className='linkedin' size='20px' /></a>
                </div>
            </div>    
        </div>
    )
